...
VL_INLINE_OPT void Vprogram_counter___024root___sequent__TOP__0(Vprogram_counter___024root* vlSelf) {
    ...
    // Body
    vlSelf->PC = ((IData)(vlSelf->rst) ? 0U : vlSelf->program_counter__DOT__next_PC);
}

VL_INLINE_OPT void Vprogram_counter___024root___combo__TOP__0(Vprogram_counter___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vprogram_counter__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vprogram_counter___024root___combo__TOP__0\n"); );
    // Body
    vlSelf->program_counter__DOT__next_PC = ((IData)(vlSelf->PCsrc)
                                              ? (vlSelf->PC 
                                                 + vlSelf->ImmOp)
                                              : ((IData)(4U) 
                                                 + vlSelf->PC));
